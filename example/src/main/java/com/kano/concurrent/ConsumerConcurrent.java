...
public class ConsumerConcurrent {
    ...
    public void testFailed() throws Exception{
        DefaultMQPushConsumer consumer = new DefaultMQPushConsumer("concurrent-failed-consumer");
        consumer.setNamesrvAddr("127.0.0.1:9876");
        consumer.subscribe("concurrent-failed-topic","*");
